...
var modalWarning = bootstrap.Modal.getOrCreateInstance("#warning");
var myToast = bootstrap.Toast.getOrCreateInstance(document.getElementById("liveToast"))
...
function checkUrl() {
  var rule = /(http(s)?:\/\/.)?(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*)/g;
  var result = urlInput.value.match(rule);
  if (result === null) {
